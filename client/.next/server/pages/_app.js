...
// EXTERNAL MODULE: external "moment/locale/uk"
var uk_ = __webpack_require__("l+bi");
...
// EXTERNAL MODULE: ./redux/reducers/index.ts
var reducers = __webpack_require__("igEJ");
...
const store = Object(external_redux_["createStore"])(reducers["default"], Object(external_redux_devtools_extension_["composeWithDevTools"])(Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a)));
...
external_moment_default.a.locale('uk');
...
/* harmony default export */ __webpack_exports__["default"] = (Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])(reducers.reduce((initial, name) => {
  initial[name] = __webpack_require__("ATmH")(`./${name}`).default;
  return initial;
}, {})));
